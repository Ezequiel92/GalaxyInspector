<div align="center">
    <h1><img src="./resources/logo.png"/ style="height: 7em;"></h1>
</div>
...
There are more advanced tools to analyze/plot the data generated by Gadget (you can see some in the [References](https://github.com/ezequiel92/GalaxyInspector#-references) section), but this module was written, not only as a basic plotting tool, but as an exercise to learn [Julia](https://julialang.org/) and software development in general (testing, documentation, version control, etc.).
