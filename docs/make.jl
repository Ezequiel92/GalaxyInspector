...
makedocs(
    ...
    pages=[
        ...
        "API" => Any[
            ...
            "api/globals/reference.md",
            "api/globals/types.md",
            "api/globals/theme.md",
            "api/globals/quantities.md",
            "api/globals/arepo.md",
            "api/analysis/data_analysis.md",
            "api/analysis/data_acquisition.md",
            "api/analysis/compute_quantities/energies.md",
            "api/analysis/compute_quantities/masses.md",
            "api/analysis/compute_quantities/positions.md",
            "api/analysis/compute_quantities/sfm.md",
            "api/analysis/compute_quantities/times.md",
            ...
            "api/auxiliary_functions/other.md",
